...
class DynamicMeanVFE(VFETemplate):
    ...
    def extract_features(self, points):
        ...
        return points_mean.contiguous(), voxel_coords.contiguous()
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        points_mean, voxel_coords = self.extract_features(points)
        ...
        if 'trans_dict' in batch_dict:
            ...
            for i in range(num_trans):
                points_mean, voxel_coords = self.extract_features(batch_dict[f'points_{i+1}'])
                batch_dict['voxel_features_' + str(i+1)] = points_mean
                batch_dict['voxel_coords_' + str(i+1)] = voxel_coords
