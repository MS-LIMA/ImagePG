...
class ProposalTargetLayer(nn.Module):
    ...
    def forward(self, batch_dict,ind=''):
        ...
        Returns:
            batch_dict:
                ...
                rcnn_cls_labels: (B, M)
        """
        batch_rois, batch_gt_of_rois, batch_gt_idx_of_rois, batch_roi_ious, batch_roi_scores, batch_roi_labels = self.sample_rois_for_rcnn(
        ...
        targets_dict = {'rois': batch_rois, 'gt_of_rois': batch_gt_of_rois, 'gt_iou_of_rois': batch_roi_ious, 'gt_idx_of_rois': batch_gt_idx_of_rois,
    ...
    def sample_rois_for_rcnn(self, batch_dict, ind=''):
        ...
        batch_gt_idx_of_rois = rois.new_zeros(batch_size, self.roi_sampler_cfg.ROI_PER_IMAGE)
        ...
        for index in range(batch_size):
            ...
            batch_gt_idx_of_rois[index] = gt_assignment[sampled_inds]

        return batch_rois, batch_gt_of_rois, batch_gt_idx_of_rois, batch_roi_ious, batch_roi_scores, batch_roi_labels
